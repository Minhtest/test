...
namespace WebApplication.Controllers
{
    ...
    public class UsersController : BaseController
    {
        ...
        public JsonResult GetDataUser(bootstrapTableParam obj, int? WarehouseId, int? RoleId)
        {
            int TotalRow = 0;
            List<UserEntity> data = _userService.GetDataUsers(obj, User.WarehouseId ?? WarehouseId, RoleId, User.RoleLevel, ref TotalRow);
            if (data == null)
            {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.drdWarehouse = _warehouseService.GetAllData();
        ...
        public JsonResult SaveUser(UserEntity user, string base64Avatar, string fileName)
        {
            try
            {
                ...
                else
                {
                    ...
                    user.WarehouseId = user.WarehouseId ?? User.WarehouseId;
