...
namespace LIB
{
    public class IplCategory : BaseService<CategoryEntity, long>, ICategory
    {
        ...
        public bool Insert_Update(CategoryEntity category)
        {
            try
            {
                DynamicParameters param = new DynamicParameters();
                ...
                return unitOfWork.ProcedureExecute("sp_Category_Insert_Update", param);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool UpdateExport(int Id, string Name, string Code)
        {
            bool execute = false;
            try
            {
                ...
                p.Add("@Name", Name);
                p.Add("@Code", Code);
                execute = (bool)unitOfWork.ProcedureExecute("ptgroupCategory_UpdateExport", p);
        ...
        public bool UpdateExport(int Id, string Name)
        {
            bool execute = false;
            try
            {
                ...
                p.Add("@Id", Id);
                p.Add("@Name", Name);
                execute = (bool)unitOfWork.ProcedureExecute("[ptgroupCategory_UpdateExport_NotCode]", p);
