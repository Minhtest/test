...
namespace LIB.Product
{
    public class IplProduct : BaseService<ProductEntity, long>, IProduct
    {
        ...
        public List<ProductEntity> GetDataProduct(bootstrapTableParam obj, int? WarehouseId, ref int totalRecord)
        {
            try
            {
        ...
        public bool CheckByBarcode(string Barcode, int WarehouseID)
        {
            try
            {
                DynamicParameters param = new DynamicParameters();
        ...
        public ProductEntity InsertOrUpdate(ProductEntity product, int WarehouseId, ref string message)
        {
            try
            {
                var param = new DynamicParameters();
                ...
                param.Add("@InventoryNumber", product.InventoryNumber);
                param.Add("@ComputeUnit", product.ComputeUnit);
                param.Add("@Price", product.Price);
                param.Add("@SellPrice", product.SellPrice);
                param.Add("@SellPriceShop", product.SellPrice);
                param.Add("@Description", product.Description);
                param.Add("@WarehouseId", WarehouseId);
                param.Add("@ExpiredDate", product.ExpiredDate);
