...
namespace LIB.Product
{
    ...
    {
        List<ProductEntity> GetDataProduct(bootstrapTableParam obj, int? WarehouseId, ref int totalRecord);
        ...
        bool CheckByBarcode(string Barcode, int WarehouseID);
        ProductEntity GetByBarcode(string Barcode, int WarehouseID);
        ProductEntity GetByID(long ID);
        ProductEntity InsertOrUpdate(ProductEntity product, int WarehouseId, ref string message);
